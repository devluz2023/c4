workspace "Amazon Web Services Example" "An example AWS deployment architecture." {
    ...
    model {
        springPetClinic = softwaresystem "Spring PetClinic" "Allows employees to view and manage information regarding the veterinarians, the clients, and their pets." {
            ...
            jenkins = container "Jenkins" "Allows employees to view and manage information regarding the veterinarians, the clients, and their pets." "Java and Spring Boot" {
                tags "Jenkins"
            }

            sonar = container "Sonar" "Allows employees to view and manage information regarding the veterinarians, the clients, and their pets." "Java and Spring Boot" {
                tags "Sonar"
            }

            bitbucket = container "Bitbucket" "Allows employees to view and manage information regarding the veterinarians, the clients, and their pets." "Java and Spring Boot" {
                tags "BITBUCKET"
            }
        }
        ...
        jenkins -> bitbucket "Get project from resporitory"
        jenkins -> sonar "running quality code"
